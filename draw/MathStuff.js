define(["esri/core/declare", 'dojo/_base/lang'], function (declare, lang) {
    var MathStuff = declare(null, {
        declaredClass: "MathStuff"

    })
    lang.mixin(MathStuff, {
        _tailFactor: 0.05,
    ...
    var bigfunc = function () {
        "use strict";
        MathStuff._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
            ...
            d.version = "1.8.4", g.constructor = d, g.kill()._gc = !1, d.killTweensOf = d.killDelayedCallsTo = c.killTweensOf, d.getTweensOf = c.getTweensOf, d.ticker = c.ticker, g.invalidate = function () {
                ...
                if (a >= d)this._totalTime = d, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = this._duration, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (i = !0, j = "onComplete"), 0 === this._duration && ((0 === a || 0 > this._rawPrevTime) && this._rawPrevTime !== a && (c = !0), this._rawPrevTime = a); else if (0 >= a)this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== f || 0 === this._duration && this._rawPrevTime > 0) && (j = "onReverseComplete", i = this._reversed), 0 > a ? (this._active = !1, 0 === this._duration && (this._rawPrevTime >= 0 && (c = !0), this._rawPrevTime = a)) : this._initted || (c = !0); else {
        ...
        }, !0), MathStuff._gsDefine("TimelineLite", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (a, b, c) {
            var d = function (a) {
            ...
            return d.version = "1.8.4", h.constructor = d, h.kill()._gc = !1, h.to = function (a, b, d, e) {
        ...
        }, !0), MathStuff._gsDefine("TimelineMax", ["TimelineLite", "TweenLite", "easing.Ease"], function (a, b, c) {
            var d = function (b) {
            ...
            return h.constructor = d, h.kill()._gc = !1, d.version = "1.8.4", h.invalidate = function () {
                ...
                if (a >= d)this._locked || (this._totalTime = d, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (n = !0, q = "onComplete", 0 === this._duration && (0 === a || 0 > this._rawPrevTime) && this._rawPrevTime !== a && (c = !0)), this._rawPrevTime = a, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, a = -1e-6) : (this._time = this._duration, a = this._duration + 1e-6); else if (0 >= a)this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== f || 0 === this._duration && this._rawPrevTime > 0 && !this._locked) && (q = "onReverseComplete", n = this._reversed), 0 > a ? (this._active = !1, 0 === this._duration && this._rawPrevTime >= 0 && (c = !0)) : this._initted || (c = !0), this._rawPrevTime = a, a = 0 === this._duration ? 0 : -1e-6; else if (this._time = this._rawPrevTime = a, !this._locked && (this._totalTime = a, 0 !== this._repeat)) {
        ...
        }, !0), MathStuff._gsDefine("plugins.BezierPlugin", ["plugins.TweenPlugin"], function (a) {
            var b = function () {
                ...
                if (a.length > 1) {
                    for (x = a[a.length - 1], w = !0, q = m.length; --q > -1;)if (r = m[q], Math.abs(p[r] - x[r]) > .05) {
                        w = !1;
                        break
                    }
            ...
            return c.constructor = b, b.API = 2, b._autoCSS = !0, b.quadraticToCubic = function (a, b, c) {
                ...
                var a = (MathStuff.GreenSockGlobals || MathStuff).com.greensock.plugins.CSSPlugin;
                if (a) {
        ...
        }, !0), MathStuff._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function (a) {
            var d, e, f, g, c = function () {
                a.call(this, "css"), this._overwriteProps.length = 0
            }, h = {}, i = c.prototype = new a("css");
            i.constructor = c, c.version = "1.8.4", c.API = 2, c.defaultTransformPerspective = 0, i = "px", c.suffixMap = {
                top: i,
                right: i,
                bottom: i,
                left: i,
            ...
            var G, H, I, J, K, L, j = /(?:\d|\-\d|\.\d|\-\.\d)+/g, k = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, l = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, m = /[^\d\-\.]/g, n = /(?:\d|\-|\+|=|#|\.)*/g, o = /opacity *= *([^)]*)/, p = /opacity:([^;]*)/, q = /alpha\(opacity *=.+?\)/i, r = /([A-Z])/g, s = /-([a-z])/gi, t = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, u = function (a, b) {
                ...
                MathStuff.console && console.log(a)
            }, P = "", Q = "", R = function (a, b) {
                b = b || C;
                var d, e, c = b.style;
                ...
                if (b = b || S(a, null))if (f = b.length)for (; --f > -1;)d[b[f].replace(s, u)] = b.getPropertyValue(b[f]); else for (f in b)d[f] = b[f]; else if (b = a.currentStyle || a.style)for (f in b)d[f.replace(s, u)] = b[f];
            ...
            var gb = function (a, b, c) {
                ...
                for (o !== n.length && (m = (f || "").split(" "), o = m.length), g.plugin = i, g.setRatio = l, q = 0; o > q; q++)if (t = m[q], u = n[q], x = parseFloat(t), x || 0 === x)g.appendXtra("", x, _(u, x), u.replace(k, ""), p && -1 !== u.indexOf("px"), !0); else if (e && ("#" === t.charAt(0) || 0 === t.indexOf("rgb") || db[t]))t = eb(t), u = eb(u), y = t.length + u.length > 6, y && !M && 0 === u[3] ? (g["xs" + g.l] += g.l ? " transparent" : "transparent", g.e = g.e.split(n[q]).join("transparent")) : (M || (y = !1), g.appendXtra(y ? "rgba(" : "rgb(", t[0], u[0] - t[0], ",", !0, !0).appendXtra("", t[1], u[1] - t[1], ",", !0).appendXtra("", t[2], u[2] - t[2], y ? "," : ")", !0), y && (t = 4 > t.length ? 1 : t[3], g.appendXtra("", t, (4 > u.length ? 1 : u[3]) - t, ")", !1))); else if (v = t.match(j)) {
            ...
            var ob = function (a, b, c, d, e, f, g) {
                ...
                if (!h[a]) {
                    ...
                    pb(a, null, function (a, c, d, e, f, g, i) {
                        var j = (MathStuff.GreenSockGlobals || MathStuff).com.greensock.plugins[b];
        ...
        }, !0), MathStuff._gsDefine("plugins.RoundPropsPlugin", ["plugins.TweenPlugin"], function (a) {
            var b = function () {
        ...
        }, !0), MathStuff._gsDefine("easing.Back1", ["easing.Ease"], function (a) {
            var n, o, b = MathStuff.GreenSockGlobals || MathStuff, c = b.com.greensock, d = 2 * Math.PI, e = Math.PI / 2, f = c._class, g = function (b, c) {
    ...
    MathStuff._gsQueue.push(bigfunc)
    !function (_windowParameter) {
        "use strict";
        var e, f, g, h, b = _windowParameter.GreenSockGlobals || _windowParameter, c = function (a) {
            var e, c = a.split("."), d = b;
            ...
            this.check = function (k) {
                ...
                if (0 === m && f)for (o = ("com.greensock." + d).split("."), p = o.pop(), q = c(o.join("."))[p] = this.gsClass = f.apply(f, h), g && (b[p] = q, "function" == typeof define && define.amd ? define((_windowParameter.GreenSockAMDPath ? _windowParameter.GreenSockAMDPath + "/" : "") + d.split(".").join("/"), [], function () {
                    return q
                }) : "undefined" != typeof module && module.exports && (module.exports = q)), l = 0; this.sc.length > l; l++)this.sc[l].check()
            }, this.check(!0)
        }, k = _windowParameter._gsDefine = function (a, b, c, d) {
        ...
        g = r.prototype, g.addEventListener = function (a, b, c, d, e) {
            ...
            if (b)for (var e, c = b.length, d = this._eventTarget; --c > -1;)e = b[c], e.up ? e.c.call(e.s || d, {
                type: a,
                target: d
            }) : e.c.call(e.s || d)
        };
        var s = _windowParameter.requestAnimationFrame, t = _windowParameter.cancelAnimationFrame, u = Date.now || function () {
                return (new Date).getTime()
            };
        for (e = ["ms", "moz", "webkit", "o"], f = e.length; --f > -1 && !s;)s = _windowParameter[e[f] + "RequestAnimationFrame"], t = _windowParameter[e[f] + "CancelAnimationFrame"] || _windowParameter[e[f] + "CancelRequestAnimationFrame"];
        l("Ticker", function (b, c) {
            var g, h, i, j, k, d = this, e = u(), f = c !== !1 && s, l = function () {
                null != i && (f && t ? t(i) : _windowParameter.clearTimeout(i), i = null)
            }, m = function (a) {
        ...
        g = v.prototype, g._dirty = g._gc = g._initted = g._paused = !1, g._totalTime = g._time = 0, g._rawPrevTime = -1, g._next = g._last = g._onUpdate = g._timeline = g.timeline = null, g._paused = !1, g.play = function (a, b) {
            ...
            if ("on" === a.substr(0, 2)) {
                ...
                if (null == b)delete this.vars[a]; else if (this.vars[a] = b, this.vars[a + "Params"] = c, this.vars[a + "Scope"] = d, c)for (var e = c.length; --e > -1;)"{self}" === c[e] && (c = this.vars[a + "Params"] = c.concat(), c[e] = this);
        ...
        var y = l("TweenLite", function (a, b, c) {
            ...
            var d, c = {};
            for (d in a)F[d] || d in b && "x" !== d && "y" !== d && "width" !== d && "height" !== d || !(!C[d] || C[d] && C[d]._autoCSS) || (c[d] = a[d], delete a[d]);
            a.css = c
        };
        g = y.prototype = new v, g.constructor = y, g.kill()._gc = !1, g.ratio = 0, g._firstPT = g._targets = g._overwrittenProps = null, g._notifyPluginsOfEnabled = !1, y.version = "1.8.4", y.defaultEase = g._ease = new o(null, null, 1, 1), y.defaultOverwrite = "auto", y.ticker = w, y.selector = _windowParameter.$ || _windowParameter.jQuery || function (b) {
                return _windowParameter.$ ? (y.selector = _windowParameter.$, _windowParameter.$(b)) : _windowParameter.document ? _windowParameter.document.getElementById("#" === b.charAt(0) ? b.substr(1) : b) : b
            };
        var C = y._plugins = {}, D = y._tweenLookup = {}, E = 0, F = {
            ease: 1,
            delay: 1,
            overwrite: 1,
            onComplete: 1,
            ...
            "true": 1,
            "false": 0
        }, H = v._rootFramesTimeline = new x, I = v._rootTimeline = new x;
        ...
        var J = function (a, b, c) {
            ...
            if (D[d || (a._gsTweenID = d = "t" + E++)] || (D[d] = {
                    target: a,
                    tweens: []
                }), b && (e = D[d].tweens, e[f = e.length] = b, c))for (; --f > -1;)e[f] === b && e.splice(f, 1);
            return D[d].tweens
        ...
        g._init = function () {
            ...
            var c, d, e, f, g, h, i, j;
            if ((b instanceof Array || z(b)) && "number" != typeof b[0])for (c = b.length; --c > -1;)this._kill(a, b[c]) && (h = !0); else {
                if (this._targets) {
            ...
            if (a && this._gc)if (this._targets)for (var c = this._targets.length; --c > -1;)this._siblings[c] = J(this._targets[c], this, !0); else this._siblings = J(this.target, this, !0);
        ...
        if (g = M.prototype, M.version = 12, M.API = 2, g._firstPT = null, g._addTween = function (a, b, c, d, e, f) {
                ...
                if (null != a[this._propName])this._overwriteProps = []; else for (var b = this._overwriteProps.length; --b > -1;)null != a[this._overwriteProps[b]] && this._overwriteProps.splice(b, 1);
                ...
                return !0
            }, e = _windowParameter._gsQueue) {
            for (f = 0; e.length > f; f++)e[f]();
            for (g in i)i[g].func || _windowParameter.console.log("GSAP encountered missing dependency: com.greensock." + g)
        }
        h = !1
    }(MathStuff);
    return MathStuff;
